...
<style>
  ...
  background-image: 
    linear-gradient(to right, rgba(102, 234, 102, 0.6), rgba(239, 236, 243, 0.6)), 
    url('images/1.jpg'); /* Replace with your image URL */
  ...
  background-repeat: no-repeat;
    ...
    .form input:focus {
      outline: none;
      background:rgb(232, 240, 231);
    }

    .form button {
      background-color:rgba(235, 80, 145, 0.96);
      color: white;
      border: green;
      border-radius: 5px;
      cursor: pointer;
